    ...
    public partial class no1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ComboGioHangId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GioHangId = table.Column<int>(type: "int", nullable: false),
                    ComboId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComboGioHangs", x => x.ComboGioHangId);
                    table.ForeignKey(
                        name: "FK_ComboGioHangs_Combos_ComboId",
                        column: x => x.ComboId,
                        principalTable: "Combos",
                        principalColumn: "ComboId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ComboGioHangs_GioHangs_GioHangId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MonAnComboId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ComboId = table.Column<int>(type: "int", nullable: false),
                    MonAnId = table.Column<int>(type: "int", nullable: false),
                    SoLuong = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MonAnCombos", x => x.MonAnComboId);
                    table.ForeignKey(
                        name: "FK_MonAnCombos_Combos_ComboId",
                        column: x => x.ComboId,
                        principalTable: "Combos",
                        principalColumn: "ComboId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MonAnCombos_MonAns_MonAnId",
                        column: x => x.MonAnId,
                        principalTable: "MonAns",
                        principalColumn: "MonAnId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MonAnGioHangId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GioHangId = table.Column<int>(type: "int", nullable: false),
                    MonAnId = table.Column<int>(type: "int", nullable: false),
                    SoLuong = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MonAnGioHangs", x => x.MonAnGioHangId);
                    table.ForeignKey(
                        name: "FK_MonAnGioHangs_GioHangs_GioHangId",
                        column: x => x.GioHangId,
                        principalTable: "GioHangs",
                        principalColumn: "GioHangId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MonAnGioHangs_MonAns_MonAnId",
                        column: x => x.MonAnId,
                        principalTable: "MonAns",
                        principalColumn: "MonAnId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComboGioHangs_ComboId",
                table: "ComboGioHangs",
                column: "ComboId");

            migrationBuilder.CreateIndex(
                name: "IX_ComboGioHangs_GioHangId",
                table: "ComboGioHangs",
                column: "GioHangId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MonAnCombos_ComboId",
                table: "MonAnCombos",
                column: "ComboId");

            migrationBuilder.CreateIndex(
                name: "IX_MonAnCombos_MonAnId",
                table: "MonAnCombos",
                column: "MonAnId");

            migrationBuilder.CreateIndex(
                name: "IX_MonAnGioHangs_GioHangId",
                table: "MonAnGioHangs",
                column: "GioHangId");

            migrationBuilder.CreateIndex(
                name: "IX_MonAnGioHangs_MonAnId",
                table: "MonAnGioHangs",
                column: "MonAnId");
